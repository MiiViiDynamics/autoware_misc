...
#include "autoware_misc/actuation_message_converter/visibility_control.hpp"
...
private:
  const rclcpp::Subscription<std_msgs::msg::String>::SharedPtr m_string_sub;
  ...
  void on_state_callback_1(const std_msgs::msg::String msg);
